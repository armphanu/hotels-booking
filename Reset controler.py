...
class Ui_Resetcontrol(object):
    ...
    def retranslateUi(self, Resetcontrol):
        ...
        self.label_3.setText(_translate("Resetcontrol", "Superior Room"))
        self.label_4.setText(_translate("Resetcontrol", "Deluxe Room"))
        ...
        self.comboBox.setItemText(0, _translate("Resetcontrol", "1"))
        self.comboBox.setItemText(1, _translate("Resetcontrol", "2"))
        self.comboBox.setItemText(2, _translate("Resetcontrol", "3"))
        self.comboBox.setItemText(3, _translate("Resetcontrol", "4"))
        self.comboBox_2.setItemText(0, _translate("Resetcontrol", "1"))
        self.comboBox_2.setItemText(1, _translate("Resetcontrol", "2"))
        self.comboBox_2.setItemText(2, _translate("Resetcontrol", "3"))
        self.comboBox_2.setItemText(3, _translate("Resetcontrol", "4"))
        self.comboBox_3.setItemText(0, _translate("Resetcontrol", "1"))
        self.comboBox_3.setItemText(1, _translate("Resetcontrol", "2"))
        self.comboBox_3.setItemText(2, _translate("Resetcontrol", "3"))
        self.comboBox_3.setItemText(3, _translate("Resetcontrol", "4"))
        self.comboBox_4.setItemText(0, _translate("Resetcontrol", "1"))
        self.comboBox_4.setItemText(1, _translate("Resetcontrol", "2"))
        self.comboBox_4.setItemText(2, _translate("Resetcontrol", "3"))
        self.comboBox_4.setItemText(3, _translate("Resetcontrol", "4"))
